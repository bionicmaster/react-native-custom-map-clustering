  ...
  (
    ...
    const _onRegionChangeComplete = (region) => {
      if (superCluster && region) {
        ...
        const zoom = returnMapZoom(region, bBox, minZoom); //1 review if performance improves
        const markers = superCluster.getClusters(bBox, zoom);
        ...
        marker.properties.point_count === 0 ? (
          ...
          renderCluster ? (
            renderCluster({
              ...
              clusterColor: pinTypeColors[marker.properties.pinType], // Use pin type to determine cluster color
              clusterTextColor,
              clusterFontFamily,
              ...marker,
            })
